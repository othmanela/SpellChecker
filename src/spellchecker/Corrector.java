...
public abstract class Corrector {
   ...
   */
  public Vector<String> matchCase(String incorrectWord, Vector<String> corrections) {
    if (incorrectWord == null || corrections == null) {
      throw new IllegalArgumentException("null input given");
    }
    Vector<String> revisedSet = new Vector<String>();
   ...
   */
  public abstract Vector<String> getCorrections(String wrong);
}
